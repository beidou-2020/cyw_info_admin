...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div class="x-body">
            <div class="layui-row">
                <form class="layui-form layui-col-md12 x-so" action="${cyw }/tup/auditedList" method="get">
                ...
                <div>
                    <c:choose>
                        ...
                        <c:when test="${totalPage == currPageNumber}">
                            <a class="prev" href="${cyw }/tup/auditedList?currentPageNumber=${currPageNumber-1}">上一页</a>
                        </c:when>
                        <c:when test="${currPageNumber<totalPage && currPageNumber>1}">
                            <a class="prev" href="${cyw }/tup/auditedList?currentPageNumber=1">首页</a>
                            <a class="prev" href="${cyw }/tup/auditedList?currentPageNumber=${currPageNumber-1}">上一页</a>
                            <a class="prev" href="${cyw }/tup/auditedList?currentPageNumber=${currPageNumber+1}">下一页</a>
                            <a class="prev" href="${cyw }/tup/auditedList?currentPageNumber=${totalPage}">尾页</a>
                        </c:when>
                        <c:otherwise>
                            <a class="prev" href="${cyw }/tup/auditedList?currentPageNumber=${currPageNumber+1}">下一页</a>
                        </c:otherwise>
